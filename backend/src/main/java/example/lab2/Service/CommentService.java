...
import example.lab2.Repostory.CommRepo;
...
public class CommentService implements ComInt {
    ...
    private CommRepo commentRepostory;
    private PostRepostory postRepostory;

    private UserRepository userRepository;
     @Autowired
    public CommentService(CommRepo commentRepostory, PostRepostory postRepostory, UserRepository userRepository) {
